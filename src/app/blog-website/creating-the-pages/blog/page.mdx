    ...
    <div className="max-w-sm rounded-lg overflow-hidden shadow-lg bg-white">
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-3">
          <h3 className="font-bold text-xl leading-tight flex-1">{post.title}</h3>
          <SimpleShare post={post} className="ml-3 flex-shrink-0" />
        </div>
...
const DropdownShare: React.FC<DropdownShareProps> = ({ post, className = "" }) => {
  const [isOpen, setIsOpen] = useState(false);
