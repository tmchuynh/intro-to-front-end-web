...
| --------------------------- | -------------- | ------------------------------------------------------------------------ |
| **Visual Studio Code**      | Cross-platform | Extensive extension library, integrated terminal, Git support            |
| **Fleet**                   | Cross-platform | JetBrains' next-gen IDE, distributed development, smart mode             |
| **JetBrains IntelliJ IDEA** | Cross-platform | Advanced code analysis, refactoring tools, multi-language support        |
| **Zed**                     | Cross-platform | Ultra-fast performance, collaborative editing, AI-powered features       |
| **Pulsar**                  | Cross-platform | Community-driven Atom successor, hackable, package ecosystem             |
| **Komodo IDE**              | Cross-platform | Multi-language support, debugging tools, and version control integration |
| **Bluefish**                | Cross-platform | Lightweight, fast, and supports multiple programming languages           |
| **Nova**                    | macOS          | Native Mac design, intelligent autocomplete, Git integration             |
| **Lapce**                   | Cross-platform | Lightning-fast, GPU-accelerated rendering, plugin system                 |
| **Eclipse**                 | Cross-platform | Plugin ecosystem, Java-centric features, project management tools        |
| **Xi Editor**               | Cross-platform | High-performance core, async architecture, plugin flexibility            |
| **Kakoune**                 | Cross-platform | Modal editing, multiple selections, client-server architecture           |
| **Amp**                     | Cross-platform | Terminal-based, minimalist design, Git integration                       |
| **Brackets**                | Cross-platform | Live preview, preprocessor support, and inline editing features          |
| **Leo Editor**              | Cross-platform | Literate programming, clone-node architecture, Python scripting          |
| **Theia**                   | Cross-platform | Cloud & desktop IDE, VS Code compatible, extensible platform             |
| **Sublime Text**            | Cross-platform | Lightweight, fast performance, and powerful search capabilities          |
| **Atom**                    | Cross-platform | Highly customizable, Git integration, and collaborative editing features |
| **NetBeans**                | Cross-platform | Java-centric, multi-language support, and project management tools       |

### Web-Specific IDEs

| IDE                         | Platform       | Key Features                                                                 |
| --------------------------- | -------------- | ---------------------------------------------------------------------------- |
| **Microsoft Visual Studio** | Windows        | Comprehensive .NET development, advanced debugging, and testing tools        |
| **Visual Studio Code**      | Cross-platform | Extensive extension library, integrated terminal, Git support                |
| **WebStorm**                | Cross-platform | JavaScript/TypeScript focus, advanced debugging, and testing tools           |
| **StackBlitz**              | Web-based      | Online IDE for Angular, React, and Vue.js with live preview                  |
| **Light Table**             | Cross-platform | Real-time feedback, inline evaluation, and plugin support                    |
| **Komodo Edit**             | Cross-platform | Lightweight, fast, and supports multiple programming languages               |
| **Code::Blocks**            | Cross-platform | C/C++ focused, lightweight, and supports multiple languages                  |
| **Nuclide**                 | Cross-platform | Built on Atom, focused on React Native and JavaScript development            |
| **Quokka.js**               | Cross-platform | Live code execution, inline results, and debugging for JavaScript/TypeScript |
| **Repl.it**                 | Web-based      | Collaborative coding, real-time execution, and multi-language support        |
| **Glitch**                  | Web-based      | Collaborative web development, real-time editing, and deployment             |
| **CodeSandbox**             | Web-based      | Online IDE for web development with live preview and collaboration           |
| **Adobe Dreamweaver**       | Cross-platform | Visual design tools, code editing, and FTP support                           |
| **Gitpod**                  | Web-based      | Cloud-based IDE with Git integration, supports multiple languages            |

### Language-Specific IDEs

| IDE                       | Language Focus    | Platform       | Key Features                                                                |
| ------------------------- | ----------------- | -------------- | --------------------------------------------------------------------------- |
| **Rider**                 | C#/.NET           | Cross-platform | Advanced debugging, refactoring tools, and .NET support                     |
| **RubyMine**              | Ruby              | Cross-platform | Intelligent code completion, debugging tools, and Rails support             |
| **CLion**                 | C/C++             | Cross-platform | Advanced code analysis, refactoring tools, and CMake support                |
| **GoLand**                | Go                | Cross-platform | Intelligent code completion, debugging tools, and Go-specific features      |
| **PyCharm**               | Python            | Cross-platform | Intelligent code completion, debugging tools, and Django support            |
| **NetBeans**              | Java              | Cross-platform | Java development focus, advanced debugging, and profiling tools             |
| **Eclipse**               | Java              | Cross-platform | Java development focus, advanced debugging, and profiling tools             |
| **IntelliJ IDEA**         | Java              | Cross-platform | Advanced code analysis, refactoring tools, and multi-language support       |
| **PyDev**                 | Python            | Cross-platform | Python development focus, intelligent code completion, and debugging tools  |
| **Dart Editor**           | Dart              | Cross-platform | Dart development focus, Flutter support, and debugging tools                |
| **Haskell IDE**           | Haskell           | Cross-platform | Haskell development focus, intelligent code completion, and debugging tools |
| **Eclipse CDT**           | C/C++             | Cross-platform | C/C++ development focus, advanced debugging, and profiling tools            |
| **Visual Studio for Mac** | .NET              | macOS          | .NET development focus, advanced debugging, and testing tools               |
| **Xcode**                 | Swift/Objective-C | macOS          | iOS/macOS development focus, advanced debugging, and testing tools          |
| **Android Studio**        | Android           | Cross-platform | Android development focus, advanced debugging, and testing tools            |
| **Kotlin IDE**            | Kotlin            | Cross-platform | Kotlin development focus, intelligent code completion, and debugging tools  |
| **Lua IDE**               | Lua               | Cross-platform | Lua development focus, intelligent code completion, and debugging tools     |
