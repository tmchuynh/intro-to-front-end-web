...
Events are the heart of interactive web applications. They allow you to respond to user actions and browser events.
...
const elementsWithDataId = findElements(document.body, 
    element => element.hasAttribute('data-id')
);
```
...
class InfiniteScroll {
    ...
    setupScrollListener() {
        window.addEventListener('scroll', this.throttle(this.checkScroll.bind(this), 100));
    }
