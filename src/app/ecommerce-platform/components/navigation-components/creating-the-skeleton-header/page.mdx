...
Head over to [The Breadcrumb Navigation](/ecommerce-platform/navigation-components/creating-the-dynamic-breadcrumb) to continue setting up your application.
