...
Next, we will implement the product listing and detail pages using the API functions we just created by displaying featured products and the categories on the home page. This will involve creating components to display products, categories, and product details, as well as integrating the API calls into our React components.

Head to [Home Page](/ecommerce-platform/creating-the-pages/home-page) to continue setting up your application.