...
Alright, wouldn't it be great to see something...on the page? Let's hook up to our API to fetch some data and get our home page up and running. We'll create a simple product listing that will utilize our dynamic breadcrumb component.

Head over to [Products API Integration](/ecommerce-platform/connecting-to-the-API/products) to continue building out your e-commerce platform.
