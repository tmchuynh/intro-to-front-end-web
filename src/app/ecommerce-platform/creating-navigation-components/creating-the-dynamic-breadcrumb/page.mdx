...
Alright, it's time to get the API integration going and get some data on the page!

Head over to [Defining Interfaces and Utility Functions](/ecommerce-platform/connecting-to-the-API/defining-types-and-interfaces) to continue building out your e-commerce platform.
