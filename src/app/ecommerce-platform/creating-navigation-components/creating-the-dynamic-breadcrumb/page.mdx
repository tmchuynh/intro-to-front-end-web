...
Head over to [Defining Types and Interfaces](/ecommerce-platform/connecting-to-the-API/defining-types-and-interfaces) to continue building out your e-commerce platform.
