...
Head over to [Creating the Breadcrumb Navigation](/ecommerce-platform/creating-navigation-components/creating-the-dynamic-breadcrumb) to continue setting up your application.
