...
| ---------------- | ---------------------- | -------------------------------------------------------------------------------------------------- |
| **Free**         | $0                     | Up to 3 collaborators, API Client, 25 collection runs, 50 free Postbot activities               |
| **Basic**        | $14                    | Everything in Free plus unlimited collaborators, 10K mock server requests, 10K monitor requests  |
| **Professional** | $29                    | Everything in Basic plus internal workspaces, partner workspaces, 25 packages, 90-day recovery  |
| **Enterprise**   | $49                    | Everything in Professional plus SSO, SCIM, reporting, audit logs, unlimited APIs                 |
