...
> **Note**: The open-source Swagger UI is completely free and includes all core documentation and testing features. SwaggerHub provides additional collaboration and hosting services.
...
```javascript
// production-optimized-config.js
