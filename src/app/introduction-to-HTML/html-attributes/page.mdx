...
<img src="photo.jpg" alt="A sunset view" width="300" height="200" class="featured-image">
```
...
<div data-userName="John">      <!-- No camelCase -->
<div data-product_id="abc123">  <!-- No underscores -->
<div data-is.premium="true">    <!-- No dots -->
```
...
<div onclick="toggleMenu()" onmouseover="showTooltip()" onmouseout="hideTooltip()">
  Interactive Element
</div>
...
<!-- ❌ Poor: Inline styles -->
<div style="background-color: green; color: white; padding: 10px; border-radius: 4px;">
  Success message
</div>
```
