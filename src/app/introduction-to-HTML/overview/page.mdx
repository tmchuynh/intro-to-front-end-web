...
- `target="_blank"` <FaChevronRight className="inline"/> opens the link in a new browser window or tab

- `rel="nofollow"` <FaChevronRight className="inline"/> tells the search engines not to follow the link and is often used to external links you don't want to endorse

- `title` <FaChevronRight className="inline"/> provides a tooltip with information that appears when the user hovers over the link
