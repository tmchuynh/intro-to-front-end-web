...
function Timeline({ events, orientation = "vertical" }) {
  ...
  const getEventTypeStyle = (type) => {
    const styles = {
      milestone: { color: "#e74c3c", icon: "🎯" },
      release: { color: "#2ecc71", icon: "🚀" },
      update: { color: "#3498db", icon: "🔄" },
      bug_fix: { color: "#f39c12", icon: "🐛" },
      feature: { color: "#9b59b6", icon: "✨" },
      meeting: { color: "#1abc9c", icon: "👥" },
      deadline: { color: "#e67e22", icon: "⏰" },
    };
    return styles[type] || { color: "#34495e", icon: "📌" };
  };
