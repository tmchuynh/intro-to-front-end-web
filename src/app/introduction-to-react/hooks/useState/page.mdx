...
function ExpenseTracker() {
  ...
  const categories = [
    ...
    { id: "entertainment", label: "Entertainment", color: "#45b7d1", icon: "🎬" },
  ...
  const getExpensesByCategory = () => {
    ...
    categories.forEach(cat => {
      categoryTotals[cat.id] = {
        ...
        count: monthlyExpenses.filter(expense => expense.category === cat.id).length
      };
    });
              ...
              <div key={category.id} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '12px', color: '#666' }}>{category.count} transactions</div>
                  </div>
                </div>
                <div style={{ 
                  height: '10px', 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  <span>{totalSpent > 0 ? ((category.total / totalSpent) * 100).toFixed(1) : 0}%</span>
                </div>
              </div>
            ))}
          </div>
            ...
            <div style={{ display: 'flex', alignItems: 'end', gap: '10px', height: '200px' }}>
              {Object.entries(weeklyTrends).map(([week, amount]) => (
                <div key={week} style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: '10px', color: '#666' }}>${amount.toFixed(0)}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <input
              ...
              onChange={(e) => setBudget(prev => ({ ...prev, monthly: parseFloat(e.target.value) || 0 }))}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '20px' }}>
            {Object.values(categoryData).map(category => {
              ...
              const percentUsed = categoryBudget > 0 ? (category.total / categoryBudget) * 100 : 0;
                ...
                <div key={category.id} style={{
                  ...
                  <div style={{ marginBottom: '10px' }}>
                    ...
                    <input
                      ...
                      style={{ padding: '4px', marginLeft: '5px', width: '100px' }}
                    />
                  </div>
                  ...
                  {categoryBudget > 0 && (
                    <>
                      ...
                      <div style={{ 
                        ...
                        {percentUsed > 100 && ` (Over by $${(category.total - categoryBudget).toFixed(2)})`}
                      </div>
                    </>
                  )}
                </div>
