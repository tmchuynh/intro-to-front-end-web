...
function ImageGalleryExample() {
  ...
  // Mock image data
  const allImages = [
    { id: 1, src: "nature1.jpg", category: "nature", alt: "Mountain landscape" },
        ...
        {categories.map(category => (
          <button
            ...
            style={{
              margin: '0 8px 8px 0',
              padding: '8px 16px',
              backgroundColor: selectedCategory === category.id ? '#28a745' : '#6c757d',
              color: 'white',
              border: 'none',
              borderRadius: '4px',
              cursor: 'pointer'
    ...
    <div>
      ...
      <div style={{
        ...
        {isPending ? (
          ...
          <>
            <h4>{chartType === "bar" ? "Bar" : "Pie"} Chart - {selectedPeriod}</h4>
            {renderChart()}
          </>
        )}
      </div>
