...
| Can be implemented by classes | Yes       | No         |
| Can define function types     | Yes       | Yes        |
| Can define object types       | Yes       | Yes        |
| Can define union types        | No        | Yes        |
| Can define intersection types | No        | Yes        |
| Can define mapped types       | No        | Yes        |
| Can define conditional types  | No        | Yes        |
| Can define utility types      | No        | Yes        |
| Supports declaration merging  | Yes       | No         |
| Can be used with generics     | Yes       | Yes        |
| Can be used with enums        | No        | Yes        |
| Supports index signatures     | Yes       | Yes        |
| Can be used with namespaces   | Yes       | No         |
