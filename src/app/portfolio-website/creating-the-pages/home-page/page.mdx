    ...
    <div className="min-h-screen bg-white text-gray-900 font-light">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
            I create digital experiences that are simple, elegant, and functional. 
      ...
      <section id="work" className="px-6 pb-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-light mb-16 text-center">Selected Work</h2>
          <div className="grid md:grid-cols-2 gap-16">
            {[1, 2, 3, 4].map((item) => (
              <div key={item} className="group cursor-pointer">
                ...
                <h3 className="text-lg font-medium mb-1">Project Title {item}</h3>
                <p className="text-gray-600 text-sm">Brief description of the project and technologies used.</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-8 text-sm font-bold tracking-wide">
              <Link href="#work" className="hover:text-yellow-400 transition-all duration-300 transform hover:scale-110">WORK</Link>
              <Link href="#about" className="hover:text-yellow-400 transition-all duration-300 transform hover:scale-110">ABOUT</Link>
              <Link href="#contact" className="hover:text-yellow-400 transition-all duration-300 transform hover:scale-110">CONTACT</Link>
            </div>
          </div>
        </div>
      </nav>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              ...
              >
                ...
                <h3 className="text-xl font-black mb-2 tracking-wide">PROJECT #{item}</h3>
                <p className="font-bold opacity-80">BLAZING FAST • RESPONSIVE • MODERN</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-semibold text-slate-900">Sarah Chen</span>
            </div>
            <div className="hidden md:flex space-x-8 text-sm font-medium">
              ...
              <Link href="#portfolio" className="text-slate-600 hover:text-blue-600 transition-colors">Portfolio</Link>
              <Link href="#testimonials" className="text-slate-600 hover:text-blue-600 transition-colors">Testimonials</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-slate-600 leading-relaxed mb-8 max-w-xl">
                I help businesses create exceptional digital experiences through modern web development and thoughtful design.
              </p>
      ...
      <section id="services" className="py-16 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: "Frontend Development", desc: "React, Next.js, TypeScript", icon: "🎨" },
              { title: "Backend Development", desc: "Node.js, Python, PostgreSQL", icon: "⚙️" },
              { title: "UI/UX Design", desc: "Figma, Adobe Creative Suite", icon: "✨" }
            ].map((service, index) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((project) => (
              <div key={project} className="group cursor-pointer">
                ...
                <h3 className="text-lg font-semibold text-slate-900 mb-2">E-commerce Platform</h3>
                <p className="text-slate-600 text-sm mb-3">A modern e-commerce solution built with Next.js and Stripe integration.</p>
