        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="w-6 h-6 flex flex-col justify-center">
              <span className={`block h-0.5 w-6 bg-current transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-1' : ''}`}></span>
              <span className={`block h-0.5 w-6 bg-current mt-1 transition-all duration-300 ${isMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`block h-0.5 w-6 bg-current mt-1 transition-all duration-300 ${isMenuOpen ? '-rotate-45 -translate-y-1' : ''}`}></span>
            </div>
          </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-yellow-400">
            <div className="flex flex-col space-y-4 pt-4">
              <Link href="/work" className="text-white hover:text-yellow-400 font-bold tracking-wide">
                WORK
              </Link>
              <Link href="/about" className="text-white hover:text-yellow-400 font-bold tracking-wide">
                ABOUT
              </Link>
              <Link href="/contact" className="bg-yellow-400 text-black px-4 py-2 font-black text-center hover:bg-white transition-colors">
                CONTACT
              </Link>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6 text-sm">
            <a href="mailto:hello@johndoe.com" className="text-gray-600 hover:text-gray-900 transition-colors">
              Email
            </a>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-lg font-bold">
            ...
            <span className="text-yellow-400 animate-pulse"> FULL-STACK DEVELOPER</span>
          </p>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-300 max-w-md leading-relaxed mb-4">
              Full-stack developer and UI designer helping businesses create exceptional 
              digital experiences through modern web development.
            </p>
            <div className="flex space-x-4">
              {[
                { name: 'LinkedIn', href: '#' },
