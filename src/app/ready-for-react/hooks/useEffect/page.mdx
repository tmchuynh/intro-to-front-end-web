  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>• Ctrl/Cmd + R: Refresh weather data</div>
        <div>• Ctrl/Cmd + T: Toggle auto-refresh</div>
  ...
  useEffect(() => {
    const updateTitle = () => {
      if (isActive) {
        ...
        document.title = `💤 ${pageTitle} - Come back!`;
      }
    };
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: "14px", opacity: 0.9 }}>
          Status: {isActive ? "🟢 Active" : "🔴 Inactive"} | Visit Duration:{" "}
      ...
      >
        ...
        >
          <div>• Ctrl/Cmd + 1/2/3: Change favicon</div>
          <div>• Ctrl/Cmd + D: Export settings</div>
          <div>• Ctrl/Cmd + R: Reset settings</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: "14px", opacity: 0.9 }}>
          {items.length} items loaded • Page {page} • {filteredItems.length}{" "}
          items shown
        </div>
      </div>
      ...
      >
        ...
        <div>• Intersection Observer for efficient scroll detection</div>
        <div>• Virtual loading with automatic retry on errors</div>
        <div>• Scroll position restoration on page refresh</div>
        <div>• Throttled scroll events for better performance</div>
        <div>• Keyboard shortcuts: Home/End keys, Ctrl+R to refresh</div>
      </div>
    </div>
  );
}
