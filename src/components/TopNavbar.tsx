    ...
    <header className="sticky top-0 z-30 backdrop-blur-sm bg-opacity-95 dark:bg-opacity-95 border-b border-border h-16 w-full -900">
      <div className="flex items-center justify-between px-4 lg:px-6 py-3">
        ...
        <div className="flex items-center">
          ...
          <button
            onClick={onToggleSidebar}
            className="hidden lg:flex hover:bg-gray-100 dark:hover:bg-gray-800 -ml-2 p-2 rounded-md text-gray-500 hover:text-gray-700 dark:hover:text-gray-200 dark:text-gray-400 transition-colors"
            aria-label="Toggle sidebar"
